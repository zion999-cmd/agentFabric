...
```
Foundation Models (Codex, GPT, DeepSeek, ...)
        │
        ▼
...
Every Agent (ChatGPT, Codex, Hermes, Codex, future agents) reads the same project
...
Truth for the entire project. Every agent (Codex, ChatGPT, Codex, Hermes) reads
